...
typedef struct _INTERNAL_SYSTEM_THREAD_INFORMATION
{
   FILETIME KernelTime;
   FILETIME UserTime;
   FILETIME CreateTime;
   ...
   DWORD WaitReason;
   DWORD Reserved1;
} INTERNAL_SYSTEM_THREAD_INFORMATION;
...
static bool thread_is_suspended(DWORD process_id, DWORD thread_id)
{
   ...
   INTERNAL_SYSTEM_THREAD_INFORMATION *sti;
   INTERNAL_SYSTEM_THREAD_INFORMATION *info = NULL;
   sti = (INTERNAL_SYSTEM_THREAD_INFORMATION*)((BYTE*)spi + sizeof(*spi));
